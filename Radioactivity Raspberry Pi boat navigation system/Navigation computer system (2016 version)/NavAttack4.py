...
def nav_data_grab():
    ...
    #The simplest way to remove them is at source
    #So the five GPS values (Track, speed, Lat, Long and Time) are cleared here
    for chknan in range (3,7):
        if math.isnan(nav_data_list[chknan][1])==True:
            nav_data_list[chknan][1]=0
            print "Its that old NaN problem Blackadder"
            print "Please reset your tripometer"
